...
class Menu(object):
    ...
    order = Toggle(800, 575, 200, 50, ["Ascending", "Descending"])
    begin = Toggle(300, 640, 600, 50, ["Begin"])
    listA = [joker, numHands, colorScheme, sortHands, order, begin]
    ...
    def draw_labels(self):
        self.disp_text("Python Card Sim v4.0", 200, 100, 800, 100, self.titleFont, labelFont)
        self.disp_text("Include Joker", 25, 275, 600, 50, self.optionFont, labelFont)
        self.disp_text("Number of Players", 25, 350, 600, 50, self.optionFont, labelFont)
        self.disp_text("Choose your theme", 25, 425, 600, 50, self.optionFont, labelFont)
